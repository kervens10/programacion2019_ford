...
*/
/*
var nombre_persona = prompt("digite un nombre de la persona");
var las_horas = parseInt(prompt("digite las horas de trabajas"));
var pago_tr = parseInt(prompt("digite pago de trabaja"));

var pago_total = las_horas * pago_tr;

console.log(`El pago total ${pago_total} usd`);
*/
